...
if(isset($_SESSION['id'])){
	if($_SESSION['id'] != 1){ // if the member happens to be logged in and is looking at the admin page, he gets redirected to member page
...
<div class="everythingContainer">
	...
	<div class="mainBodyContainer">
		...
		<div class="contentsContainer" id="contentsContainer">
			...
			<form name='editProfile' id='editProfile' action='admin.php' method='post'>
				<table border='0'>
					<tr>
						<td>Username</td>
